...
var paths = {
    ...
    node: ['./node_modules/angular-material/angular-material.min.css', './node_modules/bootstrap/dist/css/bootstrap.min.css', './node_modules/font-awesome/css/font-awesome.css'],
    destination_public: './dist/',
    destination_modules: './dist/modules/',
    destination_fonts: './dist/fonts/',
    destination_bower: ['./dist/bower_components/', './dist/bower_components/bootstrap/'],
    destination_node: ['./dist/node_modules/angular-material/', "./dist/node_modules/bootstrap/", "./dist/node_modules/"]  
};
...
gulp.task('fonts', function () {
  return gulp.src(paths.fonts)
    .pipe(gulp.dest(paths.destination_fonts));
});
...
gulp.task('node-modules-material', function () {
    ...
    gulp.src(paths.node[1]).pipe(gulp.dest(paths.destination_node[1]));
    gulp.src(paths.node[2]).pipe(gulp.dest(paths.destination_node[2]));
});
...
gulp.task('build', function () {
    runSequence(
        'clean',
        ['views', 'styles', 'img', 'fonts', 'resources', 'lint', 'javascript'],
        'browserify',
        'bower-css',
