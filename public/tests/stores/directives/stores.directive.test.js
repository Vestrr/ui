...
var objectToTest = 'storesDirective';
...
describe(objectToTest, function () {
    ...
    it('directive template attribute should be correct', function () {
      directiveElem = getCompiledElement('<div stores-directive></div>');

      expect(directiveElem).toContain('<div><span>Directive in: stores, with name: storesDirective</span></div>');
    });

    it('directive template element should be correct', function () {
      directiveElem = getCompiledElement('<stores-directive></stores-directive>');
