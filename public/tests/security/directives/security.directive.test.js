...
var objectToTest = 'securityDirective';
...
describe(objectToTest, function () {
    ...
    it('directive template attribute should be correct', function () {
      directiveElem = getCompiledElement('<div security-directive></div>');

      expect(directiveElem).toContain('<div><span>Directive in: security, with name: securityDirective</span></div>');
    });

    it('directive template element should be correct', function () {
      directiveElem = getCompiledElement('<security-directive></security-directive>');
