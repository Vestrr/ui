...
var objectToTest = 'syncDirective';
...
describe(objectToTest, function () {
    ...
    it('directive template attribute should be correct', function () {
      directiveElem = getCompiledElement('<div sync-directive></div>');

      expect(directiveElem).toContain('<div><span>Directive in: sync, with name: syncDirective</span></div>');
    });

    it('directive template element should be correct', function () {
      directiveElem = getCompiledElement('<sync-directive></sync-directive>');
