...
var objectToTest = 'appsDirective';
...
describe(objectToTest, function () {
    ...
    it('directive template attribute should be correct', function () {
      directiveElem = getCompiledElement('<div apps-directive></div>');

      expect(directiveElem).toContain('<div><span>Directive in: apps, with name: appsDirective</span></div>');
    });

    it('directive template element should be correct', function () {
      directiveElem = getCompiledElement('<apps-directive></apps-directive>');
