...
var objectToTest = 'settingsDirective';
...
describe(objectToTest, function () {
    ...
    it('directive template attribute should be correct', function () {
      directiveElem = getCompiledElement('<div settings-directive></div>');

      expect(directiveElem).toContain('<div><span>Directive in: settings, with name: settingsDirective</span></div>');
    });

    it('directive template element should be correct', function () {
      directiveElem = getCompiledElement('<settings-directive></settings-directive>');
