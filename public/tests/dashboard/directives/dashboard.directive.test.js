...
var objectToTest = 'dashboardDirective';
...
describe(objectToTest, function () {
    ...
    it('directive template attribute should be correct', function () {
      directiveElem = getCompiledElement('<div dashboard-directive></div>');

      expect(directiveElem).toContain('<div><span>Directive in: dashboard, with name: dashboardDirective</span></div>');
    });

    it('directive template element should be correct', function () {
      directiveElem = getCompiledElement('<dashboard-directive></dashboard-directive>');
