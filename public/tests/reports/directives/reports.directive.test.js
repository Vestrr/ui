...
var objectToTest = 'reportsDirective';
...
describe(objectToTest, function () {
    ...
    it('directive template attribute should be correct', function () {
      directiveElem = getCompiledElement('<div reports-directive></div>');

      expect(directiveElem).toContain('<div><span>Directive in: reports, with name: reportsDirective</span></div>');
    });

    it('directive template element should be correct', function () {
      directiveElem = getCompiledElement('<reports-directive></reports-directive>');
