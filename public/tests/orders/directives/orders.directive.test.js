...
var objectToTest = 'ordersDirective';
...
describe(objectToTest, function () {
    ...
    it('directive template attribute should be correct', function () {
      directiveElem = getCompiledElement('<div orders-directive></div>');

      expect(directiveElem).toContain('<div><span>Directive in: orders, with name: ordersDirective</span></div>');
    });

    it('directive template element should be correct', function () {
      directiveElem = getCompiledElement('<orders-directive></orders-directive>');
