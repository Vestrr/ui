...
var objectToTest = 'productsDirective';
...
describe(objectToTest, function () {
    ...
    it('directive template attribute should be correct', function () {
      directiveElem = getCompiledElement('<div products-directive></div>');

      expect(directiveElem).toContain('<div><span>Directive in: products, with name: productsDirective</span></div>');
    });

    it('directive template element should be correct', function () {
      directiveElem = getCompiledElement('<products-directive></products-directive>');
